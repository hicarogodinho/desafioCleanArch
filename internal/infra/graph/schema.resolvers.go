...
func (r *queryResolver) Orders(ctx context.Context) ([]*model.Order, error) {
	// Adapte conforme sua implementação real do ListOrdersUseCase
	output, err := r.ListOrdersUseCase.Execute() // Certifique-se que ListOrdersUseCase está na sua struct Resolver
	if err != nil {
		return nil, err
	}
